...
IF NOT EXISTS (SELECT name FROM sys.databases WHERE name = 'DWBI_HealthCare')
BEGIN
    CREATE DATABASE DWBI_HealthCare;
    PRINT 'Database DWBI_HealthCare created.';
END
ELSE
    PRINT 'Database DWBI_HealthCare already exists – skipping creation.';
GO
